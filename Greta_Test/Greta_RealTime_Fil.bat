...
utils\WAIT.exe 1
start /MIN Psyclone_BehaviorPlannerDebug_Fil.exe
utils\WAIT.exe 1
start /MIN Psyclone_BehaviorRealizerDebug_Fil.exe
utils\WAIT.exe 1
start Player.exe
::utils\WAIT.exe 1
...
taskkill /f /im Psyclone_BehaviorRealizerDebug_Fil.exe
taskkill /f /im Psyclone_BehaviorPlannerDebug_Fil.exe
